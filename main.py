...
def fill_form(address: str, name: str):
    logger.info(f'Filling form for {address} - {name}')
    value = {
        "entry.908064693": address,
        "entry.793329167": name,
    }
